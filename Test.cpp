...
TEST_CASE("addFather/addfMother method")
{
    ...
    CHECK_NOTHROW(t.addFather("b", "f"));
    CHECK_NOTHROW(t.addMother("b", "g"));
    CHECK_NOTHROW(t.addFather("f", "h"));
    CHECK_NOTHROW(t.addMother("f", "i"));
    CHECK_NOTHROW(t.addFather("h", "j"));
    CHECK_NOTHROW(t.addMother("h", "k"));
    CHECK_NOTHROW(t.addFather("c", "l"));
    CHECK_NOTHROW(t.addMother("c", "m"));
    CHECK_NOTHROW(t.addFather("c", "n"));
    CHECK_NOTHROW(t.addMother("n", "o"));
    CHECK_NOTHROW(t.addFather("o", "p"));
    CHECK_NOTHROW(t.addMother("o", "q"));
    CHECK_NOTHROW(t.addFather("g", "r"));
    CHECK_NOTHROW(t.addMother("g", "s"));
...
TEST_CASE("realation method")
{
    ...
    CHECK(t.relation("n") == "grandfather");
...
TEST_CASE("find method")
{
    ...
    CHECK(string("fn").find(t.find("grandfather")) != string::npos);
    CHECK(string("gm").find(t.find("grandmother")) != string::npos);
